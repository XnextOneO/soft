...
export const MRT_Localization_RU_Custom: MRT_Localization = {
  actions: "Действия",
  and: "и",
  cancel: "Отменить",
  ...
  sortedByColumnAsc: "Отсортировано по {column} возрастанию",
  sortedByColumnDesc: "Отсортировано по {column} убыванию",
  thenBy: ", затем ",
