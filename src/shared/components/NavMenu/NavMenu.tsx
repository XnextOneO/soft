...
const NavMenu: FC<NavMenuProperties> = ({ isMenuOpen }) => {
  ...
  //       },
  //       {
  //         key: "bic-reference-books",
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.reference-books.items.bic-reference-books.name",
  //         ),
  //         items: [
  //           {
  //             key: "rf-reference-book",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.bic-reference-books.items.rf-reference-book",
  //             ),
  //             href: "rf",
  //           },
  //           {
  ...
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.bic-reference-books.items.swift-reference-book",
  //             ),
  //             href: "swift",
  //           },
  //         ],
  ...
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.reference-books.items.normative-values.name",
  //         ),
  //         items: [
  //           {
  //             key: "regulatory-capital-by-calculations",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.normative-values.items.regulatory-capital-by-calculations",
  //             ),
  //             href: "/",
  //           },
  //           {
  //             key: "calendar",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.normative-values.items.calendar",
  //             ),
  //             href: "/",
  //           },
  //         ],
  //       },
  //       {
  //         key: "reference-books-for-international-payments-investigation",
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.reference-books.items.reference-books-for-international-payments-investigation.name",
  //         ),
  //         items: [
  //           {
  //             key: "table-message-templates",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.reference-books-for-international-payments-investigation.items.table-message-templates",
  //             ),
  //             href: "/international-payments/table-message-templates",
  //           },
  //           {
  //             key: "currency-precious-metals",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.reference-books-for-international-payments-investigation.items.currency-precious-metals",
  //             ),
  //             href: "/international-payments/currency-precious-metals",
  //           },
  //           {
  //             key: "table-describing-field-57-interpretation",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.reference-books-for-international-payments-investigation.items.table-describing-field-57-interpretation",
  //             ),
  //             href: "/international-payments/table-describing-field-57-interpretation",
  //           },
  //           {
  //             key: "table-headers-transfer-amount-ranges",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.reference-books-for-international-payments-investigation.items.table-headers-transfer-amount-ranges",
  //             ),
  //             href: "/international-payments/table-headers-transfer-amount-ranges",
  //           },
  //           {
  //             key: "table-transfer-amount-ranges",
  //             name: t(
  //               "nav-menu-stack:nav-menu-stack.reference-books.items.reference-books-for-international-payments-investigation.items.table-transfer-amount-ranges",
  //             ),
  //             href: "/international-payments/table-transfer-amount-ranges",
  //           },
  //         ],
  //       },
  //     ],
  ...
  //   },
  //   {
  //     icon: IconPaymentInvestigation,
  //     key: "payment-investigation",
  //     name: t("nav-menu-stack:nav-menu-stack.payment-investigation.name"),
  //     href: "/payment-investigation",
  //     items: [
  //       {
  //         key: "cases",
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.payment-investigation.items.cases",
  //         ),
  //         href: "/payment-investigation/cases",
  //       },
  //       {
  //         key: "messages",
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.payment-investigation.items.messages",
  //         ),
  //         href: "/payment-investigation/messages",
  //       },
  //       {
  //         key: "create-message",
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.payment-investigation.items.create-message",
  //         ),
  //         href: "/payment-investigation/create-message",
  //       },
  //       {
  //         key: "analytics",
  //         name: t(
  //           "nav-menu-stack:nav-menu-stack.payment-investigation.items.analytics",
  //         ),
  //         href: "/payment-investigation/analytics",
  //       },
  //     ],
  //   },
  //   {
